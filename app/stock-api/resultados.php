...
(select IFNULL(sum(importe),0) + IFNULL((select total from resultados where anio= '" . $results[0]["anio"] . "' and mes = '" . $results[0]["mes"] . "' and cuenta_id= '1.1.1.31'),0) from movimientos where (fecha BETWEEN '" . $anio_ant . "-" . $mes_ant . "-01' AND '" . $anio . "-" . $mes . "-01') and cuenta_id = '1.1.1.31') ahorro01,
(select IFNULL(sum(importe),0) + IFNULL((select total from resultados where anio= '" . $results[0]["anio"] . "' and mes = '" . $results[0]["mes"] . "' and cuenta_id= '1.1.1.32'),0) from movimientos where (fecha BETWEEN '" . $anio_ant . "-" . $mes_ant . "-01' AND '" . $anio . "-" . $mes . "-01') and cuenta_id = '1.1.1.32') ahorro02,
(select IFNULL(sum(importe),0) + IFNULL((select total from resultados where anio= '" . $results[0]["anio"] . "' and mes = '" . $results[0]["mes"] . "' and cuenta_id= '1.1.1.33'),0) from movimientos where (fecha BETWEEN '" . $anio_ant . "-" . $mes_ant . "-01' AND '" . $anio . "-" . $mes . "-01') and cuenta_id = '1.1.1.33') ahorro03,
(select IFNULL(sum(importe),0) + IFNULL((select total from resultados where anio= '" . $results[0]["anio"] . "' and mes = '" . $results[0]["mes"] . "' and cuenta_id= '1.1.1.34'),0) from movimientos where (fecha BETWEEN '" . $anio_ant . "-" . $mes_ant . "-01' AND '" . $anio . "-" . $mes . "-01') and cuenta_id = '1.1.1.34') ahorro04,
